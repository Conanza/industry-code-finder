class CreateMappings < ActiveRecord::Migration[5.0]
  def change
    ...
    add_index :mappings,
              [
                :ncci_code_id, :ca_code_id,
                :de_code_id, :mi_code_id, :nj_code_id,
                :ny_code_id, :pa_code_id, :tx_code_id,
                :naics_code_id, :sic_code_id,
                :iso_cgl_code_id, :general_description_id
              ],
              unique: true,
              name: 'by_gen_description_codes'
  end
end
